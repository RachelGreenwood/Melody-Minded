  ...
  return (
    <div>
        ...
        <div id='concert-photos'>
          ...
          <i onClick={previousImage} className="arrow-button left-arrow fa-solid fa-caret-left fa-2xl"></i>
          <img className="concert" src={images[ImageIndex]} alt="A photo of a choral concert" />
          <i onClick={nextImage} className="arrow-button right-arrow fa-solid fa-caret-right fa-2xl"></i>
        </div>
        <div id='mission'>
          ...
          <p>Sign in, then click "lesson one" in the navigation bar to get started!</p>
        </div>
    </div>
  );
};
