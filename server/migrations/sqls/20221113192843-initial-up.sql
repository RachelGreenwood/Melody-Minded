...
ALTER TABLE questions ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
COPY questions (id, concept_id, question, "wrong_answerA", "wrong_answerB", "wrong_answerC", correct_answer, incorrect_feedback, correct_feedback) FROM stdin;
